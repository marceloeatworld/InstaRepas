        ...
        <div class="w-full sm:w-4/5 md:w-3/5 lg:w-2/5 xl:w-1/3">
            <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="space-y-6 text-gray-700 leading-relaxed">
                    ...
                    <p><strong class="font-bold">Protection des données personnelles :</strong> "Les données personnelles que vous fournissez lors de l'inscription (nom d'utilisateur et email) sont uniquement utilisées pour la gestion de votre compte. Aucune adresse IP n'est conservée dans notre base de données. Lors de la suppression de votre compte, aucune information n'est conservée par la suite. Vos données ne sont en aucun cas transmises à des tiers. Conformément à la loi "Informatique et Libertés" et au RGPD, vous disposez d'un droit d'accès, de rectification et d'opposition aux données vous concernant, que vous pouvez exercer en nous contactant à l'adresse indiquée ci-dessus.</p>
                </div>
            </div>
        </div>
    </div>
